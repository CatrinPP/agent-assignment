  ...
  <div className="card">
    ...
    <article className="card__content">
      <h2 className="card__title">
        <span>Перспективные захоронения</span>
        <ButtonEdit />
      </h2>
      ...
      <div className="card__section">
        ...
        <div className="card__section-info">
          ...
          <div className="card__section-row">
            ...
            <p className="card__section-value card__section-value--colored"><a href="mailto:grigoriev@funeral.com">grigoriev@funeral.com</a></p>
          </div>
        </div>
      </div>
      <div className="card__section">
